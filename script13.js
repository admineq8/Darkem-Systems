...
function generatePDF() {
    ...
    img13.src = 'img/minuta13.png'; // Ruta a la nueva segunda imagen correspondiente (minuta13.png)
    ...
    img1.onload = function () {
        ...
        img13.onload = function () {
            doc.addImage(img13, 'PNG', 10, doc.lastAutoTable.finalY + 10, 190, 60); // Ajustamos el alto de la segunda imagen

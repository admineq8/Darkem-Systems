...
function generatePDF() {
    ...
    img14.src = 'img/minuta14.png'; // Ruta a la nueva segunda imagen correspondiente (minuta14.png)
    ...
    img1.onload = function () {
        ...
        img14.onload = function () {
            doc.addImage(img14, 'PNG', 10, doc.lastAutoTable.finalY + 10, 190, 60); // Ajustamos el alto de la segunda imagen

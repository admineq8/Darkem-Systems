...
function generatePDF() {
    ...
    img28.src = 'img/minuta28.png'; // Ruta a la nueva segunda imagen correspondiente (minuta28.png)

    img1.onload = function () {
        doc.addImage(img1, 'PNG', 10, 10, 190, 30); // Ajustar las coordenadas y tamaño según tu imagen

        doc.setFontSize(12);
        doc.text('Acta de cierre del proyecto', 10, 50); // Encabezado ajustado según la plantilla
        ...
        img28.onload = function () {
            doc.addImage(img28, 'PNG', 10, doc.lastAutoTable.finalY + 10, 190, 60); // Ajustamos el alto de la segunda imagen
            doc.save('acta_cierre_proyecto.pdf');
        };
    };
}

...
function generatePDF() {
    ...
    img40.src = 'img/minuta40.png'; // Ruta a la nueva segunda imagen correspondiente (minuta40.png)
    ...
    img1.onload = function () {
        ...
        img40.onload = function () {
            doc.addImage(img40, 'PNG', 10, doc.lastAutoTable.finalY + 10, 190, 60); // Ajustamos el alto de la segunda imagen

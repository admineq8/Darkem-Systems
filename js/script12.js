...
function generatePDF() {
    ...
    img12.src = 'img/minuta12.png'; // Ruta a la nueva segunda imagen correspondiente (minuta12.png)

    img1.onload = function () {
        doc.addImage(img1, 'PNG', 10, 10, 190, 30); // Ajustar las coordenadas y tamaño según tu imagen

        doc.setFontSize(12);
        doc.text('Estudio económico', 10, 50); // Encabezado ajustado según la plantilla
        ...
        img12.onload = function () {
            doc.addImage(img12, 'PNG', 10, doc.lastAutoTable.finalY + 10, 190, 60); // Ajustamos el alto de la segunda imagen
            doc.save('estudio_economico.pdf');
        };
    };
}

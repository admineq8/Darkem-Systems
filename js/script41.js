...
function generatePDF() {
    ...
    const img41 = new Image();
    img41.src = 'img/minuta41.png'; // Ruta a la nueva segunda imagen correspondiente (minuta41.png)

    img1.onload = function () {
        doc.addImage(img1, 'PNG', 10, 10, 190, 30); // Ajustar las coordenadas y tamaño según tu imagen

        doc.setFontSize(12);
        doc.text('Control de Seguimiento - Plan Operativo', 10, 50); // Encabezado ajustado según la plantilla
        ...
        img41.onload = function () {
            doc.addImage(img41, 'PNG', 10, doc.lastAutoTable.finalY + 10, 190, 60); // Ajustamos el alto de la segunda imagen

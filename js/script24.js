...
function generatePDF() {
    ...
    img24.src = 'img/minuta24.png'; // Ruta a la nueva segunda imagen correspondiente (minuta24.png)

    img1.onload = function () {
        doc.addImage(img1, 'PNG', 10, 10, 190, 30); // Ajustar las coordenadas y tamaño según tu imagen

        doc.setFontSize(12);
        doc.text('Control de Cambios', 10, 50); // Encabezado ajustado según la plantilla
        ...
        img24.onload = function () {
            doc.addImage(img24, 'PNG', 10, doc.lastAutoTable.finalY + 10, 190, 60); // Ajustamos el alto de la segunda imagen

...
function generatePDF() {
    ...
    img20.src = 'img/minuta20.png'; // Ruta a la nueva segunda imagen correspondiente (minuta20.png)

    img1.onload = function () {
        doc.addImage(img1, 'PNG', 10, 10, 190, 30); // Ajustar las coordenadas y tamaño según tu imagen

        doc.setFontSize(12);
        doc.text('Plantilla área RH', 10, 50); // Encabezado ajustado según la plantilla
        ...
        img20.onload = function () {
            doc.addImage(img20, 'PNG', 10, doc.lastAutoTable.finalY + 10, 190, 60); // Ajustamos el alto de la segunda imagen
            doc.save('plantilla_area_RH.pdf');
        };
    };
}

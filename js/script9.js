...
function generatePDF() {
    ...
    img9.src = 'img/minuta9.png'; // Ruta a la nueva segunda imagen correspondiente (minuta9.png)

    img1.onload = function () {
        doc.addImage(img1, 'PNG', 10, 10, 190, 30); // Ajustar las coordenadas y tamaño según tu imagen

        doc.setFontSize(12);
        doc.text('Cronograma de Actividades y Análisis de Gantt', 10, 50); // Encabezado ajustado según la plantilla
        ...
        doc.autoTable({
            head: [
                ['Actividades', 'Letras', 'Procedencia', 'Tiempo', 'Costo']
            ],
            body: data,
            startY: 70,
            theme: 'grid',
        ...
        img9.onload = function () {
            doc.addImage(img9, 'PNG', 10, doc.lastAutoTable.finalY + 10, 190, 60); // Ajustamos el alto de la segunda imagen
            doc.save('cronograma_gantt.pdf');
        };
    };
}

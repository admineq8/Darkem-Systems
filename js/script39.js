...
function generatePDF() {
    ...
    img39.src = 'img/minuta39.png'; // Ruta a la nueva segunda imagen correspondiente (minuta39.png)
    ...
    img1.onload = function () {
        ...
        img39.onload = function () {
            doc.addImage(img39, 'PNG', 10, doc.lastAutoTable.finalY + 10, 190, 60); // Ajustamos el alto de la segunda imagen

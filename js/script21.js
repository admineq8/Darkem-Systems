...
function generatePDF() {
    ...
    img21.src = 'img/minuta21.png'; // Ruta a la nueva segunda imagen correspondiente (minuta21.png)

    img1.onload = function () {
        doc.addImage(img1, 'PNG', 10, 10, 190, 30); // Ajustar las coordenadas y tamaño según tu imagen

        doc.setFontSize(12);
        doc.text('Área finanzas', 10, 50); // Encabezado ajustado según la plantilla
        ...
        img21.onload = function () {
            doc.addImage(img21, 'PNG', 10, doc.lastAutoTable.finalY + 10, 190, 60); // Ajustamos el alto de la segunda imagen
            doc.save('area_finanzas.pdf');
        };
    };
}

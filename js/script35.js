...
function generatePDF() {
    ...
    img35.src = 'img/minuta35.png'; // Ruta a la nueva segunda imagen correspondiente (minuta35.png)
    ...
    img1.onload = function () {
        ...
        img35.onload = function () {
            doc.addImage(img35, 'PNG', 10, doc.lastAutoTable.finalY + 10, 190, 60); // Ajustamos el alto de la segunda imagen

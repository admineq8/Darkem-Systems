...
function generatePDF() {
    ...
    const img43 = new Image();
    img43.src = 'img/minuta43.png'; // Ruta a la nueva segunda imagen correspondiente (minuta43.png)
    ...
    img1.onload = function () {
        ...
        img43.onload = function () {
            doc.addImage(img43, 'PNG', 10, doc.lastAutoTable.finalY + 10, 190, 60); // Ajustamos el alto de la segunda imagen

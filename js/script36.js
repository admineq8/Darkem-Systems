...
function generatePDF() {
    ...
    img36.src = 'img/minuta36.png'; // Ruta a la nueva segunda imagen correspondiente (minuta36.png)
    ...
    img1.onload = function () {
        ...
        img36.onload = function () {
            doc.addImage(img36, 'PNG', 10, doc.lastAutoTable.finalY + 10, 190, 60); // Ajustamos el alto de la segunda imagen

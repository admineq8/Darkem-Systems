...
function generatePDF() {
    ...
    img22.src = 'img/minuta22.png'; // Ruta a la nueva segunda imagen correspondiente (minuta22.png)

    img1.onload = function () {
        doc.addImage(img1, 'PNG', 10, 10, 190, 30); // Ajustar las coordenadas y tamaño según tu imagen

        doc.setFontSize(12);
        doc.text('Área comercial', 10, 50); // Encabezado ajustado según la plantilla
        ...
        img22.onload = function () {
            doc.addImage(img22, 'PNG', 10, doc.lastAutoTable.finalY + 10, 190, 60); // Ajustamos el alto de la segunda imagen
            doc.save('area_comercial.pdf');
        };
    };
}

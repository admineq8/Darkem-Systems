...
function generatePDF() {
    ...
    img48.src = 'img/minuta48.png'; // Ruta a la nueva segunda imagen correspondiente (minuta48.png)
    ...
    img1.onload = function () {
        ...
        img48.onload = function () {
            doc.addImage(img48, 'PNG', 10, doc.lastAutoTable.finalY + 10, 190, 60); // Ajustamos el alto de la segunda imagen

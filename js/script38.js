...
function generatePDF() {
    ...
    img38.src = 'img/minuta38.png'; // Ruta a la nueva segunda imagen correspondiente (minuta38.png)
    ...
    img1.onload = function () {
        ...
        img38.onload = function () {
            doc.addImage(img38, 'PNG', 10, doc.lastAutoTable.finalY + 10, 190, 60); // Ajustamos el alto de la segunda imagen

...
function generatePDF() {
    ...
    img31.src = 'img/minuta31.png'; // Ruta a la nueva segunda imagen correspondiente (minuta31.png)

    img1.onload = function () {
        doc.addImage(img1, 'PNG', 10, 10, 190, 30); // Ajustar las coordenadas y tamaño según tu imagen

        doc.setFontSize(12);
        doc.text('Propuesta de negocio-Idea de negocio', 10, 50); // Encabezado ajustado según la plantilla
        ...
        img31.onload = function () {
            doc.addImage(img31, 'PNG', 10, doc.lastAutoTable.finalY + 10, 190, 60); // Ajustamos el alto de la segunda imagen
            doc.save('propuesta_negocio_idea_negocio.pdf');
        };
    };
}

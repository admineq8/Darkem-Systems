...
function generatePDF() {
    ...
    const img46 = new Image();
    img46.src = 'img/minuta46.png'; // Ruta a la nueva segunda imagen correspondiente (minuta46.png)
    ...
    img1.onload = function () {
        ...
        img46.onload = function () {
            doc.addImage(img46, 'PNG', 10, doc.lastAutoTable.finalY + 10, 190, 60); // Ajustamos el alto de la segunda imagen

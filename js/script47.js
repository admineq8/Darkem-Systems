...
function generatePDF() {
    ...
    const img47 = new Image();
    img47.src = 'img/minuta47.png'; // Ruta a la nueva segunda imagen correspondiente (minuta47.png)

    img1.onload = function () {
        doc.addImage(img1, 'PNG', 10, 10, 190, 30); // Ajustar las coordenadas y tamaño según tu imagen

        doc.setFontSize(12);
        doc.text('Control de Seguimiento - Acta Constitutiva del Proyecto', 10, 50); // Encabezado ajustado según la plantilla
        ...
        img47.onload = function () {
            doc.addImage(img47, 'PNG', 10, doc.lastAutoTable.finalY + 10, 190, 60); // Ajustamos el alto de la segunda imagen
            doc.save('control_seguimiento_acta_constitutiva.pdf');
        };
    };
}

...
function generatePDF() {
    ...
    const img42 = new Image();
    img42.src = 'img/minuta42.png'; // Ruta a la nueva segunda imagen correspondiente (minuta42.png)
    ...
    img1.onload = function () {
        ...
        img42.onload = function () {
            doc.addImage(img42, 'PNG', 10, doc.lastAutoTable.finalY + 10, 190, 60); // Ajustamos el alto de la segunda imagen

...
function generatePDF() {
    ...
    const doc = new jsPDF();
    doc.text("Control de Seguimiento - Plan operativo", 10, 10);
    doc.autoTable({ 
        html: '#activity-table', 
        startY: 20,
        theme: 'grid',
    });
    doc.addImage('minuta79.png', 'PNG', 10, doc.autoTable.previous.finalY + 10, 180, 160);
    doc.save('Control_de_Seguimiento_Plan_operativo.pdf');
}

...
function generatePDF() {
    ...
    const img44 = new Image();
    img44.src = 'img/minuta44.png'; // Ruta a la nueva segunda imagen correspondiente (minuta44.png)
    ...
    img1.onload = function () {
        ...
        img44.onload = function () {
            doc.addImage(img44, 'PNG', 10, doc.lastAutoTable.finalY + 10, 190, 60); // Ajustamos el alto de la segunda imagen

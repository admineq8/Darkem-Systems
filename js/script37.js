...
function generatePDF() {
    ...
    img37.src = 'img/minuta37.png'; // Ruta a la nueva segunda imagen correspondiente (minuta37.png)

    img1.onload = function () {
        doc.addImage(img1, 'PNG', 10, 10, 190, 30); // Ajustar las coordenadas y tamaño según tu imagen

        doc.setFontSize(12);
        doc.text('Estudio Financiero', 10, 50); // Encabezado ajustado según la plantilla
        ...
        img37.onload = function () {
            doc.addImage(img37, 'PNG', 10, doc.lastAutoTable.finalY + 10, 190, 60); // Ajustamos el alto de la segunda imagen
            doc.save('estudio_financiero.pdf');
        };
    };
}

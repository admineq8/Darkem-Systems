...
function generatePDF() {
    ...
    img16.src = 'img/minuta16.png'; // Ruta a la nueva segunda imagen correspondiente (minuta16.png)

    img1.onload = function () {
        doc.addImage(img1, 'PNG', 10, 10, 190, 30); // Ajustar las coordenadas y tamaño según tu imagen

        doc.setFontSize(12);
        doc.text('Diagrama EDT y Cronograma', 10, 50); // Encabezado ajustado según la plantilla
        ...
        img16.onload = function () {
            doc.addImage(img16, 'PNG', 10, doc.lastAutoTable.finalY + 10, 190, 60); // Ajustamos el alto de la segunda imagen
            doc.save('diagrama_edt_cronograma.pdf');
        };
    };
}

...
function generatePDF() {
    ...
    img27.src = 'img/minuta27.png'; // Ruta a la nueva segunda imagen correspondiente (minuta27.png)

    img1.onload = function () {
        doc.addImage(img1, 'PNG', 10, 10, 190, 30); // Ajustar las coordenadas y tamaño según tu imagen

        doc.setFontSize(12);
        doc.text('Riesgos (Matriz de control de riesgos)', 10, 50); // Encabezado ajustado según la plantilla
        ...
        img27.onload = function () {
            doc.addImage(img27, 'PNG', 10, doc.lastAutoTable.finalY + 10, 190, 60); // Ajustamos el alto de la segunda imagen
            doc.save('matriz_control_riesgos.pdf');
        };
    };
}

...
function generatePDF() {
    ...
    img29.src = 'img/minuta29.png'; // Ruta a la nueva segunda imagen correspondiente (minuta29.png)

    img1.onload = function () {
        doc.addImage(img1, 'PNG', 10, 10, 190, 30); // Ajustar las coordenadas y tamaño según tu imagen

        doc.setFontSize(12);
        doc.text('Ruta Crítica', 10, 50); // Encabezado ajustado según la plantilla
        ...
        img29.onload = function () {
            doc.addImage(img29, 'PNG', 10, doc.lastAutoTable.finalY + 10, 190, 60); // Ajustamos el alto de la segunda imagen
            doc.save('ruta_critica.pdf');
        };
    };
}

...
function generatePDF() {
    ...
    img17.src = 'img/minuta17.png'; // Ruta a la nueva segunda imagen correspondiente (minuta17.png)

    img1.onload = function () {
        doc.addImage(img1, 'PNG', 10, 10, 190, 30); // Ajustar las coordenadas y tamaño según tu imagen

        doc.setFontSize(12);
        doc.text('Ejecución de actividades del plan operativo', 10, 50); // Encabezado ajustado según la plantilla
        ...
        img17.onload = function () {
            doc.addImage(img17, 'PNG', 10, doc.lastAutoTable.finalY + 10, 190, 60); // Ajustamos el alto de la segunda imagen
            doc.save('ejecucion_plan_operativo.pdf');
        };
    };
}

...
function generatePDF() {
    ...
    img15.src = 'img/minuta15.png'; // Ruta a la nueva segunda imagen correspondiente (minuta15.png)

    img1.onload = function () {
        doc.addImage(img1, 'PNG', 10, 10, 190, 30); // Ajustar las coordenadas y tamaño según tu imagen

        doc.setFontSize(12);
        doc.text('Plan de dirección de proyecto', 10, 50); // Encabezado ajustado según la plantilla
        ...
        img15.onload = function () {
            doc.addImage(img15, 'PNG', 10, doc.lastAutoTable.finalY + 10, 190, 60); // Ajustamos el alto de la segunda imagen

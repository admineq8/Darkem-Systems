...
function generatePDF() {
    ...
    img34.src = 'img/minuta34.png'; // Ruta a la nueva segunda imagen correspondiente (minuta34.png)
    ...
    img1.onload = function () {
        ...
        img34.onload = function () {
            doc.addImage(img34, 'PNG', 10, doc.lastAutoTable.finalY + 10, 190, 60); // Ajustamos el alto de la segunda imagen

...
function generatePDF() {
    ...
    img11.src = 'img/minuta11.png'; // Ruta a la nueva segunda imagen correspondiente (minuta11.png)

    img1.onload = function () {
        doc.addImage(img1, 'PNG', 10, 10, 190, 30); // Ajustar las coordenadas y tamaño según tu imagen

        doc.setFontSize(12);
        doc.text('Estudio de mercado', 10, 50); // Encabezado ajustado según la plantilla
        ...
        img11.onload = function () {
            doc.addImage(img11, 'PNG', 10, doc.lastAutoTable.finalY + 10, 190, 60); // Ajustamos el alto de la segunda imagen
            doc.save('estudio_mercado.pdf');
        };
    };
}

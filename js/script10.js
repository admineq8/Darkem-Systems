...
function generatePDF() {
    ...
    img10.src = 'img/minuta10.png'; // Ruta a la nueva segunda imagen correspondiente (minuta10.png)

    img1.onload = function () {
        doc.addImage(img1, 'PNG', 10, 10, 190, 30); // Ajustar las coordenadas y tamaño según tu imagen

        doc.setFontSize(12);
        doc.text('Idea del negocio', 10, 50); // Encabezado ajustado según la plantilla
        ...
        img10.onload = function () {
            doc.addImage(img10, 'PNG', 10, doc.lastAutoTable.finalY + 10, 190, 60); // Ajustamos el alto de la segunda imagen
            doc.save('idea_negocio.pdf');
        };
    };
}

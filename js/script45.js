...
function generatePDF() {
    ...
    const img45 = new Image();
    img45.src = 'img/minuta45.png'; // Ruta a la nueva segunda imagen correspondiente (minuta45.png)
    ...
    img1.onload = function () {
        ...
        img45.onload = function () {
            doc.addImage(img45, 'PNG', 10, doc.lastAutoTable.finalY + 10, 190, 60); // Ajustamos el alto de la segunda imagen

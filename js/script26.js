...
function generatePDF() {
    ...
    img26.src = 'img/minuta26.png'; // Ruta a la nueva segunda imagen correspondiente (minuta26.png)

    img1.onload = function () {
        doc.addImage(img1, 'PNG', 10, 10, 190, 30); // Ajustar las coordenadas y tamaño según tu imagen

        doc.setFontSize(12);
        doc.text('Informe Financiero', 10, 50); // Encabezado ajustado según la plantilla
        ...
        img26.onload = function () {
            doc.addImage(img26, 'PNG', 10, doc.lastAutoTable.finalY + 10, 190, 60); // Ajustamos el alto de la segunda imagen

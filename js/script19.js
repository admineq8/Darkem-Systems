...
function generatePDF() {
    ...
    img19.src = 'img/minuta19.png'; // Ruta a la nueva segunda imagen correspondiente (minuta19.png)

    img1.onload = function () {
        doc.addImage(img1, 'PNG', 10, 10, 190, 30); // Ajustar las coordenadas y tamaño según tu imagen

        doc.setFontSize(12);
        doc.text('Área operativa', 10, 50); // Encabezado ajustado según la plantilla
        ...
        img19.onload = function () {
            doc.addImage(img19, 'PNG', 10, doc.lastAutoTable.finalY + 10, 190, 60); // Ajustamos el alto de la segunda imagen
            doc.save('area_operativa.pdf');
        };
    };
}
